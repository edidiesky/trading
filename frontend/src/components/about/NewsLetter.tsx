            ...
            <CoreStyles className="w-100">
                <div className="w-100 grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div className="w-100 bg-[#D48574]">
                        <div className="py-32  w-90 auto flex flex-col gap-4">
                            <h2 className="fs-35 text-white leading-[1.4]">
                                Millions of MetaCore Point clients can’t be wrong
                            <span className="fs-24 pt-12 text-light text-light block">
                                    At MetaCore Point International, part of our mission is to keep that standard of excellence high. We provide a forex trading environment that is trustworthy, reliable and technologically advanced, while ensuring every client receives impeccable customer service.
                        ...
                        <div className="py-32  w-90 auto flex flex-col gap-4">
                            <h2 className="fs-35 text-white leading-[1.4]">
                                ...
                                <span className="fs-24 pt-12 text-light text-light block">
                                    ...
                                    Smart investment means having a variety of options. With MetaCore Point International, you can trade and invest the way you want to, by choosing independent trading or joining MetaCore Point Invest and following strategies from experienced traders. With our Loyalty Cashback program, you can also get back part of your funds on different types of commission.
                                </span>
                            </h2>
                        </div>
                    </div>
