...
export default function Right({ onsidebar, setOnSidebar }: { onsidebar?: boolean, setOnSidebar?: (value: any) => void }) {
  return (
    <RightIndexWrapper>
      {/* <Top type={'details'} /> */}
      <div className="top w-100">
        <div className="w-85 auto gap-2 flex item-start column">
          ...
          <div className="flex bottom1 w-100 column gap-2">
          ...
          {/* total */}
          <div className="flex bottom1 w-100 item-center justify-space gap-2">
