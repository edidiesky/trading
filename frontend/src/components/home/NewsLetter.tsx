...
const NewsLetter = () => {
    ...
    return (
        <NewsLetterStyles className="w-100 flex flex-col gap-12">
            <div className="auto w-[85%] lg:w-[70%]  grid grid-cols-1 md:grid-cols-3 items-center justify-center">
            ...
            <div className="auto w-[85%] mt-12 lg:w-[70%] rounded-2xl flex flex-col gap-2 border py-4 relative border-[#C89B42]">
