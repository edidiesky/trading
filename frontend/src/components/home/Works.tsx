                        ...
                        <div className="w-100 bg-[#F6F7F8] rounded-2xl pt-8 px-2">
                            <div className="w-100">
                                <div className="w-90 auto flex flex-col">
                                    ...
                                    <h2 className="text-[60px] my-3 font-extrabold">0.2</h2>
                                ...
                                <img src="https://www.indonez.com/html-demo/wave/img/in-wave-card-bg-3.png" alt="" className="w-full" />
                            </div>
                        </div>
                        ...
                        <div className="w-100 bg-[#F6F7F8] rounded-2xl pt-8 px-2">
                            <div className="w-100">
                                <div className="w-90 auto flex flex-col">
                                    ...
                                    <h2 className="text-[60px] my-3 font-extrabold">0.4</h2>
                        ...
                        <div className="w-100 bg-[#F6F7F8] rounded-2xl pt-8 px-2">
                            <div className="w-100">
                                <div className="w-90 auto flex flex-col">
                                    ...
                                    <h2 className="text-[60px] my-3 font-extrabold">0.6</h2>
                                    <p className="text-[15px] text-bold text-grey">Trade 182 FX spot pairs and 140 forwards across majors, minors, exotics and metals.</p>
                                </div>
                                <img src="https://www.indonez.com/html-demo/wave/img/in-wave-card-bg-3.png" alt="" className="w-full" />
                            </div>
                        ...
                        <div className="w-100 bg-[#F6F7F8] rounded-2xl pt-8 px-2">
                            <div className="w-100">
                                <div className="w-90 auto flex flex-col">
                                    ...
                                    <h2 className="text-[60px] my-3 font-extrabold">0.8</h2>
                                    <p className="text-[15px] text-bold text-grey">Trade 182 FX spot pairs and 140 forwards across majors, minors, exotics and metals.</p>
                                </div>
                                <img src="https://www.indonez.com/html-demo/wave/img/in-wave-card-bg-3.png" alt="" className="w-full" />
                            </div>
        ...
        return (
            <CountingStyles className="w-100 py-4">
                <div className="w-90 auto grid wrapper gap-x-12 gap-y-24 items-start lg:items-center">
                    <div className="w-100 flex flex-col gap-y-12">
                        <h2 className="text-[45px] font-extrabold">A partner invested in your
                            success</h2>
                    ...
                    <div className="w-100 flex flex-col gap-y-12">
                        <div className="w-100 grid grid-cols-2 lg:grid-cols-3">
                            <div className="p-8 py-6 w-100 flex items-center flex-col gap-1 justify-center border-b-2 border-r-2 border-[rgba(0,0,0,.1)]">
                                <img src="https://www.indonez.com/html-demo/wave/img/in-wave-icon-14.svg" alt="" className="w-24" />
                                <h4 className="fs-18 font-bold">Maximum value</h4>
                            </div>
                            <div className="p-8 py-6 w-100 hidden lg:flex items-center flex-col gap-1 justify-center border-b-2 border-r-2 border-[rgba(0,0,0,.1)]">
                                <img src="https://www.indonez.com/html-demo/wave/img/in-wave-icon-15.svg" alt="" className="w-24" />
                                <h4 className="fs-18 font-bold">Fast executions</h4>
                            </div>
                            <div className="p-8 py-6 w-100 flex items-center flex-col gap-1 justify-center border-b-2 border-[rgba(0,0,0,.1)]">
                                <img src="https://www.indonez.com/html-demo/wave/img/in-wave-icon-16.svg" alt="" className="w-24" />
                                <h4 className="fs-18 font-bold">Trading tools</h4>
                            </div>

                            <div className="p-8 py-6 w-100 flex items-center flex-col gap-1 justify-center  border-r-2 border-[rgba(0,0,0,.1)]">
                                <img src="https://www.indonez.com/html-demo/wave/img/in-wave-icon-17.svg" alt="" className="w-24" />
                                <h4 className="fs-18 font-bold">Guide & support</h4>
                            </div>
                            <div className="p-8 py-6 w-100 flex items-center flex-col gap-1 justify-center border-r-0  lg:border-r-2 border-[rgba(0,0,0,.1)]">
                                <img src="https://www.indonez.com/html-demo/wave/img/in-wave-icon-8.svg" alt="" className="w-24" />
                                <h4 className="fs-18 font-bold">Financial secure</h4>
                            </div>
                            <div className="p-8 py-6 w-100 hidden lg:flex items-center flex-col gap-1 justify-center border-[rgba(0,0,0,.1)]">
                                ...
                                <h4 className="fs-18 font-bold">Strong regulatory</h4>
                            </div>
                        </div>
                    </div>
                </div>
