...
const ManageTransactions = () => {
    ...
    React.useEffect(() => {
        if (updatedepositisSuccess) {
            toast({
                variant: "success",
                description: 'The Deposit has been successfully updated',
            })

            const timeout = setTimeout(() => {
                dispatch(cleardeposit('any'))
                navigate('/account/dashboard/deposit_list')
            }, 5000);
        }
                ...
                <div className="auto py-4 trading_wrapper flex column gap-4">
                    <div className="flex w-full trading_wrapper_top  items-start md:items-center md:flex-row flex-col gap-4 justify-between">
                        ...
                        <div className="flex items-center justify-end">
                            <button onClick={handleUpdateDeposit} className="btn fs-14 text-bold">Update Deposit</button>
                        </div>
                    </div>
                    <div className="w-100 trading_wrapper_bottom pt-12 flex flex-col gap-12">
                        <div className="w-100 grid grid-cols-1 sm:grid-cols-2 gap-4 ">
                            <div className="flex flex-col gap-1">
                                <h5 className="text-xl family1">Deposited Amount ($)</h5>
                                <input
                                    value={price}
                                    name='price'
                                    type="number"
                            ...
                            <div className="flex flex-col gap-1">
                                <h5 className="text-xl family1">Deposit Plan</h5>
                        ...
                        <div className="w-100 grid grid-cols-1 sm:grid-cols-2 gap-4 ">
                            <div className="flex flex-col gap-1">
                                <h5 className="text-xl family1">Deposit Tier</h5>
                                <input
                                    value={tier}
                                    name='tier'
                                    type="text"
                        ...
                        <div className="w-100 grid grid-cols-1 sm:grid-cols-3 gap-4 ">
                            <div className="flex flex-col gap-1">
                                <h5 className="text-xl family1">Deposit Status</h5>
                        ...
                        {/* payment proff */}
                        {
                            proofimage === '' ?
                                ...
                                : <div className="w-full pt-8 flex flex-col gap-2">
                                    <h5 className="text-xl family1">Deposit Payment Proof</h5>
